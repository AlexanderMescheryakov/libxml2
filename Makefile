...
ACLOCAL = ${SHELL} /g2/src/specific/vxworks/libxml2/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /g2/src/specific/vxworks/libxml2/missing --run autoconf
AUTOHEADER = ${SHELL} /g2/src/specific/vxworks/libxml2/missing --run autoheader
AUTOMAKE = ${SHELL} /g2/src/specific/vxworks/libxml2/missing --run automake-1.11
AWK = gawk
...
CFLAGS = -g -O2 $(VX_CC_FLAGS) -I/g2/src/specific/vxworks/libiconv/include
#CPP = gcc -E
CPPFLAGS = $(VX_CC_FLAGS) -I/g2/src/specific/vxworks/libiconv/include
CYGPATH_W = echo
...
LIBXML_VERSION_INFO = 11:8:9
LIBXML_VERSION_NUMBER = 20908
LIPO = 
LN_S = ln -s
LTLIBOBJS = 
LZMA_CFLAGS = 
LZMA_LIBS = 
MAINT = 
MAKEINFO = ${SHELL} /g2/src/specific/vxworks/libxml2/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MODULE_EXTENSION = .so
...
PYTHON_LIBS = -L/usr/lib/python2.7/config-x86_64-linux-gnu -L/usr/lib -lpthread -ldl  -lutil -lm  -lpython2.7 -Xlinker -export-dynamic -Wl,-O1 -Wl,-Bsymbolic-functions
...
Z_CFLAGS =  
Z_LIBS = -lz  
abs_builddir = /g2/src/specific/vxworks/libxml2
abs_srcdir = /g2/src/specific/vxworks/libxml2
abs_top_builddir = /g2/src/specific/vxworks/libxml2
abs_top_srcdir = /g2/src/specific/vxworks/libxml2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /g2/src/specific/vxworks/libxml2/install-sh
